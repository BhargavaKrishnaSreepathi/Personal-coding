...
for i in range(len(predictions)):
    collage.append(predictions[i][0])
    face.append(predictions[i][1])
    floorplan.append(predictions[i][2])
    map.append(predictions[i][3])
    property.append(predictions[i][4])
    siteplan.append(predictions[i][5])
    text.append(predictions[i][6])
...
df1.to_csv(r'C:\Users\krish\Desktop\Property Guru\pg-image-moderation\Trained_models\labelled_model_data_validation_final_vgg.csv')
print ('saved the predictions')

combined_labels = pd.read_csv(r'C:\Users\krish\Desktop\Property Guru\pg-image-moderation\Trained_models\labelled_model_data_validation_final_vgg.csv')
...
df.to_csv(r'C:\Users\krish\Desktop\Property Guru\pg-image-moderation\Trained_models\submission_all_vgg.csv')
print (bhar)
