...
json_file = open(r"C:\Users\krish\Documents\GitHub\Personal-coding\Machine_learning\Property_Guru\model_data_validation_final_all_interview_bw_further.json", "r")
loaded_model_json = json_file.read()
json_file.close()
predictive_model = model_from_json(loaded_model_json)
# load weights into new model
predictive_model.load_weights(r"C:\Users\krish\Documents\GitHub\Personal-coding\Machine_learning\Property_Guru\model_data_validation_final_all_interview_bw_further.h5")
print("Loaded model from disk")


sgd = SGD(lr=0.01, decay=1e-6, momentum=0.9, nesterov=True)

predictive_model.compile(loss='binary_crossentropy', optimizer=sgd, metrics = ['accuracy'])
...
with open("model_data_validation_final_all_interview_bw_further_2.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
predictive_model.save_weights("model_data_validation_final_all_interview_bw_further_2.h5")
