...
json_file = open("model_data_validation_final_all_last_try.json", 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
# load weights into new model
loaded_model.load_weights("model_data_validation_final_all_last_try.h5")
...
for i in range(len(test)):
    ...
    img = image.load_img(r'C:\Users\krish\Desktop\Property Guru\pg-image-moderation/all_images\image_moderation_images/' + str(test.loc[i, 'images_id']), target_size=(IMG_SIZE, IMG_SIZE, 3))
...
df1.to_csv(r'C:\Users\krish\Desktop\Property Guru\pg-image-moderation\Trained_models\labelled_model_data_validation_final_last_try.csv')
print ('saved the predictions')

combined_labels = pd.read_csv(r'C:\Users\krish\Desktop\Property Guru\pg-image-moderation\Trained_models\labelled_model_data_validation_final_last_try.csv')
...
df.to_csv(r'C:\Users\krish\Desktop\Property Guru\pg-image-moderation\Trained_models\submission_all_last_try.csv')
print (bhar)
