...
mypath = r'C:\Users\krish\Desktop\Jay COdes/filter_bathroom_mar'
onlyfiles = [f for f in listdir(mypath) if isfile(join(mypath, f))]

# for k in range(len(onlyfiles)):
for k in range(1):

    df = pd.read_csv(r'C:\Users\krish\Desktop\Jay COdes/filter_bathroom_mar/' + onlyfiles[k])
    ...
    # for i in range(1):
        ...
        for xc in result:
            plt.axvline(x=xc)
        plt.savefig(r'C:\Users\krish\Desktop\Jay COdes/humidity_results/' + str(current_date) + '.pdf')
        plt.close()
        # a = [0] + result
        # min_temperature = 50
    ...
    # df_min_temp.to_csv(r'C:\Users\krish\Desktop\Jay COdes/humidity_results/min_humidity_' + onlyfiles[k])
